    ...
    return (
      <div className="min-h-screen bg-base-200 flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-base-content/70">Loading scooties...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-base-100 border-b border-base-300 sticky top-0 z-40 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              <h1 className="text-4xl font-bold text-base-content">Available Scooters</h1>
              <p className="mt-2 text-base-content/70">Find the perfect ride for your Weligama adventure.</p>
            </div>
            <div className="alert alert-warning w-fit shadow-sm">
                    ...
                    {[...Array(Math.min(pagination.totalPages, 5))].map((_, i) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-medium transition-colors ${pagination.currentPage === pageNum
